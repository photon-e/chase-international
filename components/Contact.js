      ...
      <div className="section-container">
        <div className="reveal mx-auto max-w-3xl rounded-2xl bg-white p-8 shadow-sm sm:p-10">
          ...
          <address className="mt-8 not-italic text-slate-700">
            <p className="mb-3">
              <span className="font-semibold text-slate-900">Address:</span> No. 4, Damboa Road, Borno State
            </p>
            <p className="mb-3">
              <span className="font-semibold text-slate-900">Phone:</span>{' '}
              <a className="hover:text-blue-700" href="tel:08016341046">
                08016341046
              </a>
              ,{' '}
              <a className="hover:text-blue-700" href="tel:08191701041">
                08191701041
              </a>
            </p>
            <p>
              <span className="font-semibold text-slate-900">Email:</span>{' '}
              <a className="hover:text-blue-700" href="mailto:chaseninternational78@gmail.com">
